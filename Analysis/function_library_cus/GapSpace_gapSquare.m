function [Eccent, Orient, x, y, elementClusterTags] = GapSpace_gapSquare(Side_region, Width_region, Gap_region, trialNum, noiseP, scWidth, scHeight, bgWidth, rot_ang, tgSeed)
